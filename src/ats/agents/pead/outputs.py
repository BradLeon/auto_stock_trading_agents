...
# Shared with every other agent's outputs.py — see agents/coerce.py for why these
# must not be re-implemented per package (the macro review lacked them and failed
# validation on a live run, silently serving last week's regime).
from ..coerce import (  # noqa: E402
    _as_list,
    _as_objlist,
    _as_strlist,
    _split_jsonish_array,
)
