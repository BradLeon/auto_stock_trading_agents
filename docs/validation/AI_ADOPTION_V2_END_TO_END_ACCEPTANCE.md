...
> **历史验收记录。** 其中的 `ons_bics_ai`（英国 ONS BICS AI）已于 2026-09-19 正式退役
> （`retire-ons-bics-ai`），其库内 5,081 条观测 / 5,081 条 series / 3 个 artifact / 2 条
> source check 已按显式 purge 清除且**不导出**。本文中与 ONS 相关的验收步骤与结论**仅作历史
> 记录**，不代表当前接入状态；L1 三条轴的验收结论不受该来源退役影响。
