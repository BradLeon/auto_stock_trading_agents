...
from ...core.structured_models import CatalogStatus, FetchRequest
...
def _tw_mof():
    from ...sources.tw_mof import TaiwanMOFAdapter

    return TaiwanMOFAdapter()


def _kr_ecos():
    from ...sources.kr_ecos import KoreaECOSAdapter
...
def _company_disclosures():
    from ...sources.company_financials import CompanyDisclosuresAdapter

    return CompanyDisclosuresAdapter()


def _defeatbeta():
    from ...sources.company_financials import DefeatBetaStatementAdapter

    return DefeatBetaStatementAdapter()


def _yfinance_financials():
    from ...sources.company_financials import YFinanceFinancialStatementsAdapter
...
def ingest_source(repository, source_id: str, *, entities: list[str] | None = None,
    ...
    from ...pipelines.structured.ingestion import IngestionPipeline
