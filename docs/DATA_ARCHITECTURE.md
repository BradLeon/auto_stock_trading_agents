...
- SemiAnalysis 等订阅内容先由共享采集入口落地，PEAD 与 Evidence 再分别消费，不再各自连接 IMAP / RSS。
...
当前里程碑状态：阶段一已完成共享研报主链路，其他文档连接器渐进迁移；阶段二的平台底座已完成但既有行情/财务源尚待迁入；阶段三已完成兼容拆分；阶段四已交付 V1 查询与 CLI。
