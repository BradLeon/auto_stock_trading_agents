...
content completeness.  The release and filing SHALL retain CIK, form,
accession, source URL, filing date, and report date when supplied by SEC.  The
transcript SHALL retain its provider, report date, fiscal period, and validated
